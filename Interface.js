...
function fillCircle(gridPosX, gridPosY) {
  noStroke();
  //Center
  data.setValue(gridPosX,gridPosY,maxm(data.getValue(gridPosX,gridPosY)+125,200));
  fill(0,0,0,255/2);
  rect(gridPosX*(gridInterval),gridPosY*(gridInterval), gridInterval, gridInterval);
  //Right
  if ( gridPosX+1 < 28 ) {
    //1 right
    data.setValue(gridPosX+1,gridPosY,maxm(data.getValue(gridPosX+1,gridPosY)+85,200));
    fill(0,0,0,255/3);
  ...
  if ( gridPosY-1 >= 0 ) {
    //1 left
    data.setValue(gridPosX,gridPosY-1,maxm(data.getValue(gridPosX,gridPosY-1)+85,200));
    fill(0,0,0,255/3);
